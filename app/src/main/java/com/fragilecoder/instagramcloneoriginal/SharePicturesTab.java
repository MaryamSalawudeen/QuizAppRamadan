...
public class SharePicturesTab extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtenter = view.findViewById(R.id.edtenter);
            ...
            case R.id.btnshare:
                if (receivedImageBitmap != null) {
                    if (edtenter.getText().toString().equals(" ")) {
                        FancyToast.makeText(getContext(), "Error! You must specify a description..", Toast.LENGTH_LONG, FancyToast.ERROR, false).show();
                    } else {
                        ...
                        parseObject.put("image_des", edtenter.getText().toString());
                    ...
                    FancyToast.makeText(getContext(), "Error! You must select an image.", Toast.LENGTH_LONG, FancyToast.ERROR, false).show();
                }
                break;
